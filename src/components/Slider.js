  ...
  return (
    ...
    onMouseLeave={()=>setPaused(!paused)}>
        ...
        <div className="arrows">
            <IoIosArrowDropleftCircle  className="left" onClick={() => updateActiveIndex(activeIndex - 1)}/>
            <IoIosArrowDroprightCircle className="right" onClick={() => updateActiveIndex(activeIndex + 1)}/>
        </div>
    </div>
  )
}
